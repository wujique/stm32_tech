...
在前面的程序中，没有使用中断，从执行流程上来说，就只有main函数中的while(1)循环执行。
...
如果你频繁的去门口看是否有人来，你就没时间干其他事情。

如果你一个小时才去看一次，那很可能就会让快递员等一个小时，或者，快递人都不等你，等了一会没人开门就走了。**这样，你就会丢掉一个快递。**
...
实际上，中断其实是内核在管理。所以，要搞懂芯片的中断，需要学习两部分知识。
...
3. 中断线只有16根，所有PORT的相同编号的IO，通用线，只能用同时有一个IO具有中断功能。
